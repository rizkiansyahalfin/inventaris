...
<div class="h-full flex flex-col bg-white dark:bg-gray-800">
    ...
    <div class="flex items-center justify-center h-16 px-4 border-b border-gray-200 dark:border-gray-700">
        <div class="sidebar-icon">
            <svg class="w-8 h-8 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                <path
                    d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 2v12h16V6H4zm2 2h12v2H6V8zm0 4h8v2H6v-2z" />
            </svg>
        </div>
    ...
    <div class="hidden md:flex items-center justify-end px-2 py-2 border-b border-gray-200 dark:border-gray-700">
        <button id="sidebar-collapse"
            class="p-1.5 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors"
    ...
    <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <!-- Lokasi - Prioritas 6.5 untuk Admin -->
        @if($user && $user->hasRole('admin'))
            <a href="{{ route('locations.index') }}"
                class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('locations.*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700' }}"
                title="Lokasi">
                <div class="sidebar-icon">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span class="sidebar-text ml-3">Lokasi</span>
            </a>
        @endif

        <!-- Laporan - Prioritas 7 untuk Admin & Petugas -->
        @if($user && ($user->hasRole('petugas') || $user->hasRole('admin')))
