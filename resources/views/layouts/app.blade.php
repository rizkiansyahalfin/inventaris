...
<head>
    ...
    <title>@hasSection('page_title') @yield('page_title') - @endif {{ config('app.name', 'Inventaris Pondok') }}</title>
    ...
    <style>
        ...
        .navbar-fixed {
            ...
            top: 0;
            left: 256px;
            /* Start from sidebar width on desktop */
            right: 0;
            z-index: 40;
            /* Lower than sidebar */
...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-900">
    ...
    <nav id="navbar"
        class="navbar-fixed bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        @include('layouts.navigation')
    </nav>

    <!-- Sidebar - Fixed -->
    <aside id="sidebar"
        class="sidebar-fixed bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700">
    ...
    <div id="main-content" class="min-h-screen content-with-navbar main-content-shifted">
        ...
        <main class="flex-1 p-4 sm:p-6">
            <!-- Flash Messages -->
            @if (session('success'))
                <div class="mb-4 bg-green-100 dark:bg-green-900/30 border border-green-400 dark:border-green-800 text-green-700 dark:text-green-300 px-4 py-3 rounded-lg shadow-sm"
                    role="alert">
            ...
            @if (session('error'))
                <div class="mb-4 bg-red-100 dark:bg-red-900/30 border border-red-400 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded-lg shadow-sm"
                    role="alert">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
