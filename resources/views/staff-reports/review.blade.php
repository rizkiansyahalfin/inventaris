            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <span class="text-sm font-medium text-gray-500">Pembuat:</span>
                            <span class="text-sm text-gray-900 ml-2">{{ $staffReport->user->name }}</span>
                        </div>
                        <div>
                            <span class="text-sm font-medium text-gray-500">Tanggal Laporan:</span>
                            <span class="text-sm text-gray-900 ml-2">{{ $staffReport->report_date->format('d M Y') }}</span>
                        </div>
                        <div>
                            <span class="text-sm font-medium text-gray-500">Jam Kerja:</span>
                            <span class="text-sm text-gray-900 ml-2">{{ $staffReport->hours_worked }} jam</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <form action="{{ route('staff-reports.review', $staffReport) }}" method="POST">
                        ...
                        <div>
                            <label for="review_notes" class="block text-sm font-medium text-gray-700">Catatan Review *</label>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            <button type="submit" 
                                    class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 active:bg-purple-800">
                                Submit Review
                            </button>
                        </div>
                    </form>
