        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <a href="{{ route('borrows.index', ['created_at' => 'today']) }}"
                                class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:underline">Peminjaman Hari
                                Ini</a>
                            <a href="{{ route('borrows.index', ['created_at' => 'today']) }}"
                                class="ml-2 text-blue-500 hover:underline text-xs flex items-center" title="Lihat Detail">
                        ...
                        <div class="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">
                            {{ $stats['today_borrows'] }}</div>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <a href="{{ route('borrows.index', ['return_date' => 'today']) }}"
                                class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:underline">Pengembalian
                                Hari Ini</a>
                            <a href="{{ route('borrows.index', ['return_date' => 'today']) }}"
                                class="ml-2 text-blue-500 hover:underline text-xs flex items-center" title="Lihat Detail">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">
                            {{ $stats['today_returns'] }}</div>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <a href="{{ route('borrows.index', ['status' => 'borrowed', 'overdue' => '1']) }}"
                                class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:underline">Terlambat
                                Dikembalikan</a>
                            <a href="{{ route('borrows.index', ['status' => 'borrowed', 'overdue' => '1']) }}"
                                class="ml-2 text-blue-500 hover:underline text-xs flex items-center" title="Lihat Detail">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                        ...
                        <div class="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100">
                            {{ $stats['pending_returns'] }}</div>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <a href="{{ route('items.index', ['stock' => 'low']) }}"
                                class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:underline">Stok Kritis</a>
                            <a href="{{ route('items.index', ['stock' => 'low']) }}"
                                class="ml-2 text-blue-500 hover:underline text-xs flex items-center" title="Lihat Detail">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <a href="{{ route('borrows.index') }}"
                                class="text-lg font-medium text-gray-900 dark:text-gray-100 hover:underline">Peminjaman per
                                Bulan</a>
                            <a href="{{ route('borrows.index') }}"
                                class="ml-2 text-blue-500 hover:underline text-sm flex items-center" title="Lihat Detail">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M14 3h7m0 0v7m0-7L10 14m-7 7h7a2 2 0 002-2v-7" />
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <a href="{{ route('items.index') }}"
                                class="text-lg font-medium text-gray-900 dark:text-gray-100 hover:underline">Barang per
                                Kategori</a>
                            <a href="{{ route('items.index') }}"
                                class="ml-2 text-blue-500 hover:underline text-sm flex items-center" title="Lihat Detail">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <a href="{{ route('borrows.index', ['created_at' => 'today', 'approval_status' => 'pending']) }}"
                                class="text-lg font-medium text-gray-900 dark:text-gray-100 hover:underline">Peminjaman Hari
                                Ini</a>
                            <a href="{{ route('borrows.index', ['created_at' => 'today', 'approval_status' => 'pending']) }}"
                                class="ml-2 text-blue-500 hover:underline text-sm flex items-center" title="Lihat Semua">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M14 3h7m0 0v7m0-7L10 14m-7 7h7a2 2 0 002-2v-7" />
                                    ...
                                    @foreach($todayBorrows as $borrow)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $borrow->user?->name ?? 'User tidak ditemukan' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $borrow->item?->name ?? 'Barang tidak ditemukan' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $borrow->created_at->format('d/m/Y') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                ...
                                                <form action="{{ route('borrows.reject', $borrow) }}" method="POST"
                                                    ...
                                                    <input type="hidden" name="rejection_reason"
                                                        value="Ditolak oleh petugas dari dashboard">
                                                    <button type="submit"
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <a href="{{ route('borrows.index', ['status' => 'borrowed', 'due_soon' => '1']) }}"
                                class="text-lg font-medium text-gray-900 dark:text-gray-100 hover:underline">Pengembalian
                                yang Akan Datang</a>
                            <a href="{{ route('borrows.index', ['status' => 'borrowed', 'due_soon' => '1']) }}"
                                class="ml-2 text-blue-500 hover:underline text-sm flex items-center" title="Lihat Semua">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                    ...
                                    @foreach($upcomingReturns as $borrow)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $borrow->item?->name ?? 'Barang tidak ditemukan' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                                {{ $borrow->due_date->format('d/m/Y') }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
